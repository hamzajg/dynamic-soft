...
export function screenshotUrl(runId, suite, scenario, filename) {
  return `${API_BASE}/api/v1/verifications/${runId}/screenshots/${filename}?suite=${suite}&scenario=${scenario}`;
}

export function frameUrl(runId, suite, scenario, filename) {
  return `${API_BASE}/api/v1/verifications/${runId}/frames/${filename}?suite=${suite}&scenario=${scenario}`;
}

export function videoUrl(runId, suite, scenario) {
  return `${API_BASE}/api/v1/verifications/${runId}/video?suite=${suite}&scenario=${scenario}`;
}
